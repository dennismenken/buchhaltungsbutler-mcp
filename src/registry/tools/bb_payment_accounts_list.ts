// Werkzeug 43 von 54: `/accounts/get`.
//
// Stufe 1 des Beschreibungsbudgets, weil hier die Namensentscheidung trägt:
...
// `offset`, keinen Filter: Er liefert immer alle Konten. Das Werkzeug
// trägt deshalb nur das serverseitige `response_format`, das nie an die API geht.
//
// **Er wird nie zwischengespeichert**: Die Kontenliste des Mandanten ist die
